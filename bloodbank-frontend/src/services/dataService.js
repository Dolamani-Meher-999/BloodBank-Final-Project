 ...
 * Corresponds to your backend route: /api/request/create.
 */
const createRequest = async (requestData) => {
    try {
        ...
        const message = error.response?.data?.message || 'Failed to submit blood request.';
        throw new Error(message);
    }
};
 ...
 * Corresponds to your backend route: /api/request/myrequests.
 */
