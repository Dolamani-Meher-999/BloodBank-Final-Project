...
//                 return;
//             }
//             // Mock eligibility calculation (Updated for better display logic)
//             const lastDonationDate = new Date('2025-05-15');
//             const nextEligibleDate = new Date(lastDonationDate.setMonth(lastDonationDate.getMonth() + 3));
//             const now = new Date();
...
//     useEffect(() => {
//         // FIX: Added typeof THREE check to ensure it exists globally before attempting init
...
//     // Status style helper
//     const isEligible = nextDonationInfo.includes('Ready');


//     return (
//         <div className="dashboard-container">
//              {/* Load Three.js globally for stability */}
...
//                 .content-wrapper {
//                     position: relative; z-index: 10; max-width: 1400px; margin: 0 auto; padding: 0 1.5rem;
//                 }
...
//                 .eligibility-info { margin-top: 1.5rem; }
//                 .status-ready { background-color: #10b981; color: #fff; padding: 1rem; border-radius: 0.75rem; font-size: 1rem; font-weight: 700; text-align: center; box-shadow: 0 4px 6px rgba(16, 185, 129, 0.3); display: flex; align-items: center; justify-content: center; gap: 10px; }
//                 .status-scheduled { background-color: #f59e0b; color: #fff; padding: 1rem; border-radius: 0.75rem; font-size: 1rem; font-weight: 700; text-align: center; box-shadow: 0 4px 6px rgba(245, 158, 11, 0.3); display: flex; align-items: center; justify-content: center; gap: 10px; }
...
//                 {/* Secondary Grid: FINAL LAYOUT FIX */}
...
//                                 <div className={`status-badge ${isEligible ? 'status-ready' : 'status-scheduled'}`}>
//                                     {isEligible ? <CheckCircle size={20} /> : <AlertCircle size={20} />}
//                                     {nextDonationInfo}
//                                 </div>
//                                 <p style={{ fontSize: '0.85rem', color: '#6b7280', marginTop: '10px' }}>
//                                     *Standard 3-month gap is recommended after your last donation (2025-05-15).
//                                 </p>
//                             </div>
//                         </Card>
