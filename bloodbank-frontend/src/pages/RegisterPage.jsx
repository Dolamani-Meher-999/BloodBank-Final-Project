...
function RequestsPage() {
    ...
    const fetchRequests = useCallback(async () => {
        ...
        try {
            ...
            // Assuming response is an array of requests or { requests: [...] }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // dataService.createRequest returns the entire Axios response object
            ...
            // FIX: Correctly extract data from the response object
            const savedRequest = newRequestResponse.data;
            ...
            // Error is caught from the service layer
            setError(err.message || 'Failed to submit request. Please check the network.');
        } finally {
            setIsSubmitting(false);
        }
    };
